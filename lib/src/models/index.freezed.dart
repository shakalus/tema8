...
class _$Movie$ implements Movie$ {
  ...
  @override
  String toString() {
    return 'Movie(id: $id, title: $title, year: $year, rating: $rating, runtime: $runtime, summary: $summary, mediumImage: $mediumImage, largeImage: $largeImage, torrents: $torrents)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, year, rating, runtime, summary, mediumImage, largeImage,
...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Movie> movies, List<int> liked, bool isLoading, Movie? selectedMovie, int page});
...
class _$AppState$ implements AppState$ {
  ...
  @override
  String toString() {
    return 'AppState(movies: $movies, liked: $liked, isLoading: $isLoading, selectedMovie: $selectedMovie, page: $page)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, const DeepCollectionEquality().hash(_movies),
      const DeepCollectionEquality().hash(_liked), isLoading, selectedMovie, page);
